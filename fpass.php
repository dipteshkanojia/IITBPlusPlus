	...
	<div class="container">
	  ...
	  <form class="form-signin" method="post">
		...
		<input type="email" class="input-block-level" placeholder="Email address" name="txtemail" required />
	 	<hr />
		<div>
			<div style="float: left; width: 50%;"><button class="btn btn-danger btn-primary" type="submit" name="btn-submit">Generate new Password</button></div>
				<div style="float: right;"><a href="home.php"><input type="button" class="btn btn-md btn-danger" value="Cancel"></input></a></div>
			</div>
	  </form>
